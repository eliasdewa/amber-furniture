...
const ProductSection = () => {
  ...
  return (
    <section className="mt-16">
      <Title topic={'Latest Popular Furniture'} description={'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod vitae facere optio ex quos. Vitae itaque aliquam inventore suscipit quis!'} />
      {/* Rendering Products */}
